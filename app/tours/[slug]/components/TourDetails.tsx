  ...
  return (
    <section className="w-full py-8">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col gap-6 md:flex-row md:justify-between md:items-start"></div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <p className="text-muted-foreground font-inter">
                  This immersive virtual tour showcases every detail of the{" "}
                  {title}. Created using Matterport Pro2 4K technology, this
                  tour allows visitors to explore the space as if they were
                  physically present. The high-resolution imagery captures the
                  unique features and design elements that make this space
                  special.
                </p>
                <h2 className="text-xl font-bold mt-4 mb-2 font-montserrat">
                  Features
                </h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-sm font-medium font-montserrat">
                      Client
                    </h3>
                    <p className="text-muted-foreground font-inter">
                      Sample Client Inc.
                ...
                <div className="mt-6">
                  ...
                  <p className="text-sm mt-2 font-medium font-montserrat">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
              {Array.from({ length: 9 }).map((_, i) => (
                <div key={i} className="overflow-hidden rounded-lg">
                  <Image
                    src={`/placeholder.svg?height=300&width=400&text=Photo ${
                      i + 1
                    }`}
                    alt={`${title} - Photo ${i + 1}`}
                    width={400}
